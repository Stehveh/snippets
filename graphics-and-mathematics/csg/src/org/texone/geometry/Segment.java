...
public class Segment implements Cloneable {
	...
	public Object clone() {
		try {
			...
			clone.startPos = (Vertex) startPos.clone();
			clone.endPos = (Vertex) endPos.clone();
	...
	private boolean setEdge(Vertex vertex1, Vertex vertex2) {
		Vertex point1 = vertex1.getPosition();
		Vertex point2 = vertex2.getPosition();
		Vertex edgeDirection = new Vertex(point2.x - point1.x, point2.y - point1.y, point2.z - point1.z);
